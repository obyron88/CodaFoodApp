...
// Router.route('/panierlist/:price', function () {
//     this.render(this.params.price,{
//         data:{
//             price:this.params.price
//         }});
// });
// Router.route('/panierlist/:countitem', function () {
//     this.render(this.params.countitem,{
//         data:{
//             countitem:this.params.countitem
//         }});
// });